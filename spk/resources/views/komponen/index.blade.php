...
<div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('komponen.index') }}" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
                      ...
                      <table class="table table-bordered table-contextual">
                        ...
                        @foreach($itemkomponen as $komponen)
                          <tr class="table-info">
                            ...
                            <td> {{ $komponen->criteria->name }} </td>
                            <td> {{ $komponen->nilai }} </td>
                            <td> 
                                <a href="{{ route('komponen.edit', $komponen->id) }}" class="btn btn-sm btn-primary mr-2 mb-2">Edit</a>
